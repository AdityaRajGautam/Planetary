      ...
      <div className="h-full flex justify-center items-center p-4">
        <div className="container grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="text-white space-y-4 lg:pr-36">
            ...
            <a
              href="https://cdn.pannellum.org/2.5/pannellum.htm#panorama=https://pannellum.org/images/alma.jpg"
              target="_blank"
            >
              <button
                data-aos="fade-up"
            ...
            <a
              href="https://65e8773a04e8b313d8258858--symphonious-biscotti-4380a1.netlify.app/"
              target="_blank"
            >
              <button
                data-aos="fade-up"
            ...
            <p data-aos="fade-up" data-aos-delay="300">
              ...
              orbiting the Earth. Our cutting-edge satellite technology provides
              a unique perspective on our planet, allowing you to witness its
              beauty and complexity like never before.
            </p>
